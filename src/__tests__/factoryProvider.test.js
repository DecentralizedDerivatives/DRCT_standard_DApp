...
describe('factoryProvider testing', () => {
  ...
  describe('Factories', () => {
    it('Returns Main', () => {
      const expectedResult = [
        {
          address: '0xce971acf8b9b0ce67a8018c4af2094b02c22da43',
          type: 'btc',
          symbol: 'BTC/USD',
          duration: 7,
          multiplier: 1,
        ...
        {
          address: '0x8ff7e9f04fed4a6d7184962c6c44d2e701c2fb8a',
          type: 'eth',
          symbol: 'ETH/USD',
          duration: 7,
          multiplier: 5,
    ...
    it('Returns RINKEBY default', () => {
      const expectedResult = [
        {
          address: '0x92217550aba5912ba7eb70978871daf7d6bcc16d',
          type: 'btc',
          symbol: 'BTC/USD',
          duration: 7,
          multiplier: 1,
        ...
        {
          address: '0xf55e6ce774cec3817467aed5f5a5769f006658d0',
          type: 'eth',
          symbol: 'ETH/USD',
          duration: 7,
          multiplier: 5,
